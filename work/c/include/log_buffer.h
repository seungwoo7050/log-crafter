 ...
 * Track: C
 * MVP: mvp5
 * Change: Introduce bounded log entry cloning and sanitization helpers for the security-focused buffer hardening.
...
#define LC_LOG_BUFFER_MAX_MESSAGE_LENGTH 1024
