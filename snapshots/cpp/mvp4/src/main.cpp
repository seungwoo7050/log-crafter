 ...
 * Track: C++
 * MVP: mvp4
 * Change: Extend the CLI with persistence toggles and updated messaging for the MVP4 server build.
...
void print_usage(const char *prog) {
    std::cerr << "Usage: " << prog
              ...
              << "Runs the LogCrafter C++ MVP4 server with persistence and advanced query handling." << std::endl;
}
