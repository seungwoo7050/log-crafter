 ...
 * Track: C++
 * MVP: mvp2
 * Change: Extend the MVP2 CLI to expose worker and capacity tuning flags for the threaded server.
...
void print_usage(const char *prog) {
    std::cerr << "Usage: " << prog
              ...
              << "Runs the LogCrafter C++ MVP2 server with threaded query handling." << std::endl;
}
