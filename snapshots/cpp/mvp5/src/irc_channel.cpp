 ...
 * Track: C++
 * MVP: mvp5
 * Change: Implement the IRC channel container operations and log broadcast filtering.
...
IRCChannel::IRCChannel() : name_(), topic_(), broadcasts_logs_(false), filter_(), members_() {}
