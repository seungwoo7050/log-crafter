 ...
 * Track: C++
 * MVP: mvp5
 * Change: Extend the CLI with IRC toggles alongside persistence controls for the MVP5 server build.
...
void print_usage(const char *prog) {
    std::cerr << "Usage: " << prog
              ...
              << "Runs the LogCrafter C++ MVP5 server with persistence, IRC streaming, and advanced query handling." << std::endl;
}
