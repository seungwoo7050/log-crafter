 ...
 * Track: C++
 * MVP: mvp3
 * Change: Refresh the MVP3 CLI messaging to reflect advanced query support while keeping runtime tuning flags.
...
void print_usage(const char *prog) {
    std::cerr << "Usage: " << prog
              ...
              << "Runs the LogCrafter C++ MVP3 server with advanced query handling." << std::endl;
}
